...
int ufrn_al5d::configurar_porta(int fd)
{
    int portstatus = 0;
...
int ufrn_al5d::abrir_porta(void)
{
...
int ufrn_al5d::enviar_comando(char* data, int fd)
{
...
void ufrn_al5d::fechar_porta(int fd)
{
    close(fd);
}

unsigned int ufrn_al5d::trava(unsigned int canal, unsigned int pos)
{
    switch(canal)
    {
    case BAS_SERVO:
